...
public class Main extends JFrame {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (m == openItem) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(thisWindow, "Invalid File Name", "Cannot open " + pathName, JOptionPane.ERROR_MESSAGE);
                    return;
                }
    ...
    private class SearchAction implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            ...
            textArea.setText("\"" + word + "\" in " + searchEngine.getURL() + ": " + numHits + " hit(s)\n\n");
