...
public class CryptogramMenu extends JMenuBar {
    private Main cryptogram;
    private JMenuItem openItem, saveItem, exitItem;

    public CryptogramMenu(Main crypto, ActionListener decodeAction) {
        cryptogram = crypto;
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (m == openItem) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(cryptogram, "Invalid File Name", "Cannot open " + pathName, JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(cryptogram, "Invalid File Name", "Cannot create " + pathName, JOptionPane.ERROR_MESSAGE);
                    return;
                }
